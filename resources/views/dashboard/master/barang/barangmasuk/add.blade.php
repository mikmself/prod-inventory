...
<div class="row">
  <div class="col-xxl">
    <div class="card mb-4">
      <div class="card-body">
        <h5 class="mb-4">Tambah data masal barang habis pakai</h5>
        <form action="{{route('importbarangmasukhabispakai')}}" method="POST" enctype="multipart/form-data">
          @csrf
...
<div class="row">
  <div class="col-xxl">
    <div class="card mb-4">
      <div class="card-body">
        <h5 class="mb-4">Tambah data masal barang modal</h5>
        <form action="{{route('importbarangmasukmodal')}}" method="POST" enctype="multipart/form-data">
          @csrf
          <small>Download contoh file : <a href="{{route('downloadexcelbarangmasuk')}}">Download</a></small>
          <div class="row mb-3">
            <label class="col-sm-2 col-form-label" for="file">File (Excel)</label>
