...
class BarangKeluar implements FromArray, WithHeadings, WithEvents, WithStyles, WithDrawings, ShouldAutoSize, WithCustomStartCell
{
    public $req;
    ...
    public function registerEvents(): array
    {
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->setCellValue('B2', 'LAPORAN BARANG KELUAR');
