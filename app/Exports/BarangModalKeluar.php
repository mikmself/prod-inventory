...
class BarangModalKeluar implements FromArray, WithHeadings, WithEvents, WithStyles, WithDrawings, ShouldAutoSize, WithCustomStartCell
{
    public $req;
        ...
        return [
            AfterSheet::class => function(AfterSheet $event) {
                ...
                $event->sheet->getDelegate()->getStyle('C6:D6')
                        ...
                        ->getStartColor()
                        ->setARGB('8094FF');
                $event->sheet->getDelegate()->getStyle('E6')
                        ->getFill()
                        ->setFillType(Fill::FILL_SOLID)
                        ->getStartColor()
                        ->setARGB('8094FF');
                        
                $event->sheet->setCellValue('B2', 'LAPORAN BARANG MODAL KELUAR');
