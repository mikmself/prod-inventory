...
Route::prefix('admin/dashboard')->middleware(['cektoken','levelcheck'])->group(function () {
    ...
    Route::prefix('master')->group(function(){
        Route::prefix('barang')->group(function(){
            ...
            Route::post('/printbarcode/{id}',[BarangController::class,'printBarcode'])->name('printBarcode');
            ...
            Route::post('/importbarangmasukmodal',[BarangController::class,'importbarangmasukmodal'])->name('importbarangmasukmodal');
